...
begin
  ...
  logger.info("Accessing to http://kokushiboricp-coupon.jp/")
  driver.navigate.to "http://kokushiboricp-coupon.jp/"
  ...
  logger.info("agree")
  twenty_button = driver.find_element(:class => "icheckbox_minimal-aero")
  twenty_button.click

  logger.info("Select twitter to apply")
  apply_with_twitter = driver.find_element(:class => "btns-social")
    .find_element(:class => "fade")
  ...
  driver.find_element(:name => "twitter_comment").send_keys apply_comment
  driver.find_elements(:tag_name => "button")[0].click

  logger.info("Confirm")
  driver.find_element(:class => "btns").find_elements(:tag_name => "img")[1].click
